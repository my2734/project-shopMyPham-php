        ...
        <div class="x_content">
            ...
            <form class="form-label-left input_mask" method="POST">
                ...
                <div class="col-md-12 col-sm-12  form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" value="<?php echo $size_name; ?>" name="size_name" id="size_name" required placeholder="Nhập tên thương hiệu">
                </div>
                <div class="col-md-12 col-sm-12  form-group has-feedback">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="1" name="size_status" id="size_status"> Ẩn/Hiện thương hiệu
                        </label>
                    </div>
                </div>
