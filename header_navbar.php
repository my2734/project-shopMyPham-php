        ...
        <div class="container">
            <a class="navbar-brand" href="./index.php">
                <div class="header__logo">
                    <img src="./assets/img/images.png" style="height: 94px;" alt="">
                </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav_new" aria-current="page" style="color: #000;" href="./index.php">Trang chủ</a>
                    </li>
                    <?php
                    ...
                    ?>
                            <li class="nav-item">
                                <a class="nav_new" style="color: #000;" href="index.php?page=product&id=<?php echo $rowCat["cat_id"]; ?>"><?php echo $rowCat["cat_name"] ?></a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav_new" style="color: #000;" href="index.php?page=gioithieu">Giới thiệu</a>
                    </li>
