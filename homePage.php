            ...
            <div class="col-lg-3 display-block" style="margin-bottom: 50px;">
                <div class="card card-product">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./index.php?page=detailtPro&id=<?php echo $rowPro["pro_id"] ?>" class="btn" style="border: none; color: #fff;outline: none;background-color: #4aa2bb;margin-left: 33px;">Thêm vào giỏ hàng</a>
                    </div>
                </div>
            </div>
    <?php }
